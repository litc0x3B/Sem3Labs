...
TEST(linkedListSequenceTest, concat)
{
    ...
    Sequence<int> *list1 = new LinkedListSequence<int>(arr1, ARRAY_SIZE(arr1));
    Sequence<int> *list2 = new LinkedListSequence<int>(arr2, ARRAY_SIZE(arr2));
...
TEST(linkedListSequenceTest, subsequence)
{
    ...
    containersEqual(*subList, answer, ARRAY_SIZE(answer));
    EXPECT_EQ(subList->GetSize(), ARRAY_SIZE(answer));
...
TEST(linkedListSequenceTest, popback)
{
    ...
    containersEqual(*list, answer, ARRAY_SIZE(answer));
    EXPECT_EQ(list->GetSize(), ARRAY_SIZE(answer));
